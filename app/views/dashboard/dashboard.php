...
<div class="card mb-4 border-primary">
    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <h4 class="mb-1"><?php echo htmlspecialchars($_SESSION['full_name']); ?></h4>
                <p class="text-muted mb-2">@<?php echo htmlspecialchars($_SESSION['username']); ?></p>
                <div class="d-flex gap-2">
                    <span class="badge bg-warning">Level <?php echo $_SESSION['level']; ?></span>
                    <span class="badge bg-success"><?php echo number_format($_SESSION['total_points']); ?> Poin</span>
                </div>
            </div>
            <div class="col-md-3 text-center">
                <?php if($user_rank <= 3): ?>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach($leaderboard as $index => $player): ?>
                            <tr class="<?php echo $player['id'] == $_SESSION['user_id'] ? 'table-primary' : ''; ?> leaderboard-item">
                                ...
                                <td class="text-center">
                                    <img src="/public/images/avatars/<?php echo $player['avatar'] ?? 'default.png'; ?>" 
                                         alt="Avatar" class="rounded-circle <?php echo $player['id'] == $_SESSION['user_id'] ? 'border border-primary border-2' : ''; ?>" 
                                         width="50" height="50">
                                </td>
                                <td>
                                    <div>
                                        <h6 class="mb-1 <?php echo $player['id'] == $_SESSION['user_id'] ? 'text-primary fw-bold' : ''; ?>">
